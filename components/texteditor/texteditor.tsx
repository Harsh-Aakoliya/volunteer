...
import { fetchAnnouncements, createAnnouncement } from '@/api/admin';
  ...
  const handleCreateAnnouncement = async () => {
    ...
    try {
      ...
      if (announcementId) {
        ...
        if (!user?.userId) {
          throw new Error('User ID is required to create announcement');
        }
        result = await createAnnouncement(title, content, user.userId);
