...
import { ActivityIndicator, View, Text, Alert, SafeAreaView } from 'react-native';
...
export default function UserProfilePage() {
  ...
  if (isLoading) {
    return (
      ...
      //   </View>
      // </View>
      <SafeAreaView className="flex-1 bg-gray-50"><ActivityIndicator size="large" color="#0286ff" /><Text className="text-gray-600 mt-2">Loading user data...</Text></SafeAreaView>
    );
  }
