...
//   const hexToBase64 = (hex:any) => {
//     const hexArray = hex.match(/.{1,2}/g); // split into byte pairs
//     const byteArray = Uint8Array.from(hexArray.map((byte:any) => parseInt(byte, 16)));
//     return btoa(String.fromCharCode(...byteArray));
//   };
//   const getfile = async () => {
//     try {
//       setReadytoshow(false);
//       const response = await axios.get(`http://104.198.158.228:5000/media/${id}`, {
...
//       console.log('Video URI prepared.');
//     } catch (error) {
...
//           `http://104.198.158.228:5000/upload`,
//           formData,
//           {
//             headers: {
...
//           <Button title="Load Video" onPress={getfile} />
//           {uri ? readytoshow ? (
//             <Video
//               source={{ uri }}
//               useNativeControls
